        ...
        >
          ...
          >
            <div className="bg-[#09112C] text-white p-4 rounded-lg">
              ...
              <p className="text-[#09112C] text-normal">{projects[selectItemIndex].shortDescription}</p>
              <p className=" text-normal mb-4">{projects[selectItemIndex].detailedDescription}</p>
                <div className='flex items-center justify-between'>
                <a href={projects[selectItemIndex].url} target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-mint transition duration-300">
